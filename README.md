...
## Part 0: Background
This is an introductory guide for aspiring game developers, especially those who are new to participating in the Video Game Design Club (VGDev) or making games in general.
